# Expression Engineering Reference Example

## Overview

This is a public-safe reference fixture aligned with Permea's long-term sequence-first delivery and expression engineering direction.

## What this example demonstrates

- expression-engineering artifact-package structure
- validator-compatible reference files
...
This package is a reference example/template. It does not claim expression improvement, delivery performance, model performance, source acquisition, source rights confirmation, or wet-lab validation by Permea.
...
Run `python3 scripts/permea_check.py examples/expression_engineering_reference_example`, then inspect [../../REPRODUCIBILITY.md](../../REPRODUCIBILITY.md).
